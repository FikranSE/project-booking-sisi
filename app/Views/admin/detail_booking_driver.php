      ...
      <div class="card-body">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-6 mb-3">
            ...
            <input type="text" class="form-control" id="JamMulai" name="jam_mulai" style="width: 80%; border-radius: 10px;" readonly value="<?= $bookingDrivers['jam_mulai']; ?>">
          </div>
          <div class="col-sm-6 mb-3">
            <label for="JamSelesai" style="color: #281362; font-weight: 600;">Jam Selesai</label>
            <input type="text" class="form-control" id="jamSelesai" name="jam_selesai" style="width: 80%; border-radius: 10px;" readonly value="<?= $bookingDrivers['jam_selesai']; ?>">
          </div>
          <div class="col-sm-6 mb-3">
