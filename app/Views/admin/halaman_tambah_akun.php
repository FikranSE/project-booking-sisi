    ...
    <form class="styled-box-6" action="<?= site_url('admin/simpanAkun'); ?>" method="post">
      <div class="card-body">
        <div class="form-group row">
          ...
          <div class="col-sm-6 mb-3">
            <label for="jabatan" style="color: #281362; font-weight: 600;">Jabatan<sup class="text-danger">*</sup></label>
            <input type="text" class="form-control" id="jabatan" name="jabatan" style="width: 80%; border-radius: 10px;" placeholder="Jabatan" required>
          </div>
          <div class="col-sm-6 mb-3">
