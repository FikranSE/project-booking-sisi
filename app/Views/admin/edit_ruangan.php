      ...
      <div class="card-body">
        <div class="form-group row">
          <div class="col-sm-6 mb-3">
            ...
            <input type="text" class="form-control" id="nama" name="nama" style="width: 80%; border-radius: 10px;" placeholder="Nama Ruangan" value="<?= set_value('nama', $room['nama_ruangan']); ?>">
          </div>
          <div class="col-sm-6 mb-3">
        ...
        <div class="form-group row justify-content-between text-right">
          ...
          <div class="col-sm-6">
            <a id="btnBatal" class="btn btn-secondary" style="color: #ffffff; width: 100px; margin-right: 2%; border-radius: 20px;" href="ruangan">Batal</a>
